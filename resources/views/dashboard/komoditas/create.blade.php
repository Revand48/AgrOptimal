...
@section('content')
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Tambah Komoditas Baru</h1>
                <p class="text-sm text-gray-500 mt-1">Tambahkan data tanaman untuk simulasi.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-100/80 overflow-hidden max-w-4xl">
            ...
            <form action="{{ route('admin.komoditas.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" required rows="3"
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none"
                            placeholder="Penjelasan singkat tentang tanaman ini..."></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="risks" rows="2"
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none"
                            placeholder="Wereng, Tikus, Burung, Kekeringan..."></textarea>
