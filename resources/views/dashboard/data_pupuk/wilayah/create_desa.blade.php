...
@section('content')
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Tambah Desa</h1>
                <p class="text-sm text-gray-500 mt-1">Desa harus terikat ke kecamatan agar data pupuk saling berkaitan.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-100/80 overflow-hidden max-w-xl">
            ...
            <form action="/dashboard/data_pupuk/wilayah/desa" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="hidden" name="kecamatan_id" id="kecamatanInput">
