...
@section('content')
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Edit Kecamatan</h1>
                <p class="text-sm text-gray-500 mt-1">Perbarui data kecamatan yang sudah ada.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-100/80 overflow-hidden max-w-xl relative">
            ...
            <form action="/dashboard/data_pupuk/wilayah/kecamatan/{{ $kecamatan->id }}" method="POST"
                ...
                <div>
                    ...
                    <input type="text" name="nama" required value="{{ old('nama', $kecamatan->nama) }}"
