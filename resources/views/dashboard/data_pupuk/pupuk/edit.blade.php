...
@section('content')
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Edit Pupuk</h1>
                <p class="text-sm text-gray-500 mt-1">Perbarui data pupuk yang sudah ada.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-100/80 overflow-hidden max-w-xl relative">
            ...
            <form action="/dashboard/data_pupuk/pupuk/{{ $pupuk->id }}" method="POST"
                ...
                <div>
                    ...
                    <input type="text" name="nama" required value="{{ old('nama', $pupuk->nama) }}"
                ...
                {{-- Kategori --}}
                <div x-data="{ open: false, selected: '{{ old('kategori', $pupuk->kategori) }}' }">
                    <label class="block text-xs font-semibold text-green-700 uppercase tracking-wider mb-2">
                ...
                <div>
                    ...
                    <input type="number" name="kg_per_sak" required value="{{ old('kg_per_sak', $pupuk->kg_per_sak) }}"
                        class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 focus:bg-white outline-none transition-all duration-300"
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_sak" required value="{{ old('jumlah_sak', $pupuk->jumlah_sak) }}"
                        class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 focus:bg-white outline-none transition-all duration-300"
