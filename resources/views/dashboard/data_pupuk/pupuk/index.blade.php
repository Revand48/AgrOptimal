...
@section('content')
    ...
    @endif">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Manajemen Pupuk</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola data pupuk untuk distribusi.</p>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-800">Data Pupuk</h2>
                            <p class="text-xs text-gray-500">Daftar pupuk yang tersedia.</p>
                        </div>
                    </div>
                    <a href="/dashboard/data_pupuk/pupuk/create"
                        ...
                        <tbody class="divide-y divide-green-50">
                            @forelse($pupuks as $pupuk)
                                <tr class="hover:bg-green-50/50 transition-colors">
                                    <td class="p-4 text-gray-700 font-medium">{{ $pupuk->nama }}</td>
                                    <td class="p-4 text-center">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $pupuk->kategori == 'Subsidi' ? 'bg-blue-100 text-blue-800 border border-blue-200' : 'bg-orange-100 text-orange-800 border border-orange-200' }}">
                                            {{ $pupuk->kategori }}
                                        </span>
                                    </td>
                                    <td class="p-4 text-center text-gray-600">{{ $pupuk->kg_per_sak }} kg</td>
                                    <td class="p-4 text-center text-gray-600">{{ $pupuk->jumlah_sak }} sak</td>
                                    <td class="p-4 text-center">
                                        <span
                                            ...
                                            {{ $pupuk->jumlah_sak * $pupuk->kg_per_sak }} kg
                                        </span>
                                    </td>
                                    <td class="p-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="/dashboard/data_pupuk/pupuk/{{ $pupuk->id }}/edit"
                                            ...
                                            <button type="button"
                                                @click="openDeleteModal('/dashboard/data_pupuk/pupuk/{{ $pupuk->id }}', '{{ $pupuk->nama }}')"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="p-8 text-center text-gray-500">
                                        ...
                                        <p class="font-medium">Belum ada data pupuk</p>
                                        <p class="text-sm mt-1">Klik tombol "Tambah Pupuk" untuk menambah data baru.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
