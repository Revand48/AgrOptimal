...
@section('title', 'Tambah Tips Irigasi')
...
@section('content')
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Tambah Tips Irigasi</h1>
                <p class="text-sm text-gray-500 mt-1">Tambahkan langkah baru untuk panduan irigasi.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-100/80 overflow-hidden max-w-4xl relative">
            ...
            <form action="{{ route('admin.edukasi.irigasi.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-semibold text-green-700 uppercase tracking-wider mb-2">
                            Urutan Langkah <span class="text-red-500">*</span>
                        </label>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" required
                        class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 focus:bg-white outline-none transition-all duration-300"></textarea>
                    <div>
                        <label class="block text-xs font-semibold text-green-700 uppercase tracking-wider mb-2">
                            URL Video (YouTube)
                        </label>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Masukkan link video YouTube jika ada.</p>
                    </div>
                </div>
                    ...
                    <div x-data="{ tab: 'padi' }" class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                        ...
                        <div x-show="tab === 'padi'" x-transition:enter="transition ease-out duration-200"
                            ...
                            <textarea name="content_padi" rows="5"
                                class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none"
                                placeholder="Tips khusus untuk Padi..."></textarea>
                        </div>
                        <div x-show="tab === 'jagung'" style="display: none;"
                            ...
                            <textarea name="content_jagung" rows="5"
                                class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none"
                                placeholder="Tips khusus untuk Jagung..."></textarea>
                        </div>
                        <div x-show="tab === 'kedelai'" style="display: none;"
                            ...
                            <textarea name="content_kedelai" rows="5"
                                class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none"
                                placeholder="Tips khusus untuk Kedelai..."></textarea>
                        </div>
                        <div x-show="tab === 'singkong'" style="display: none;"
                            ...
                            <textarea name="content_singkong" rows="5"
                                class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none"
                                placeholder="Tips khusus untuk Singkong..."></textarea>
                        </div>
                        <div x-show="tab === 'ubi'" style="display: none;"
                            ...
                            <textarea name="content_ubi" rows="5"
                                class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none"
                                placeholder="Tips khusus untuk Ubi..."></textarea>
                        </div>
                    </div>
                </div>
