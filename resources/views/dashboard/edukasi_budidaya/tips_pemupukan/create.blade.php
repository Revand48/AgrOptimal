...
@section('title', 'Tambah Tips Pemupukan')
...
@section('content')
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Tambah Tips Pemupukan</h1>
                <p class="text-sm text-gray-500 mt-1">Tambahkan langkah baru untuk panduan pemupukan.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-100/80 overflow-hidden max-w-4xl relative">
            ...
            <form action="{{ route('admin.edukasi.tips_pemupukan.store') }}" method="POST" enctype="multipart/form-data"
