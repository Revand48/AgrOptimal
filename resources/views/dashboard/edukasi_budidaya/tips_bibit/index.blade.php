...
@section('title', 'Kelola Tips Bibit')
...
@section('content')
    ...
    @endif">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Tips Bibit</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola langkah-langkah tips bibit untuk pengguna.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-100/80 overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    ...
                    <a href="{{ route('admin.edukasi.tips_bibit.create') }}"
                                ...
                                <tr class="hover:bg-green-50/50 transition-colors">
                                    ...
                                    <td class="p-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="{{ route('admin.edukasi.tips_bibit.edit', $tip->id) }}"
                                            ...
                                            <button type="button"
                                                @click="openDeleteModal('{{ route('admin.edukasi.tips_bibit.destroy', $tip->id) }}', '{{ $tip->title }}')"
