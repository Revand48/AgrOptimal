...
@section('title', 'Kelola Cek Tanah Tradisional')
...
@section('content')
    ...
    @endif">
        ...
        <div x-show="notification.show" x-transition:enter="transition ease-out duration-300"
            ...
            class="fixed top-5 right-5 text-white px-4 py-2 rounded-lg shadow-lg z-[60] flex items-center gap-3" x-cloak>
            ...
            <div @click.outside="closeDeleteModal()" x-show="deleteModal.show"
                ...
                <div class="p-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 mb-6">
                        <p class="text-sm text-gray-600">Apakah Anda yakin ingin menghapus langkah:</p>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-green-700">Cek Tanah Tradisional</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola langkah-langkah cek tanah secara tradisional untuk pengguna.
                </p>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-800">Daftar Langkah</h2>
                            <p class="text-xs text-gray-500">Semua data langkah tersimpan.</p>
                        </div>
                    </div>
                    <a href="{{ route('admin.edukasi.cek_tanah.create') }}"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-green-50">
                            @forelse($cekTanahs as $item)
                                <tr class="hover:bg-green-50/50 transition-colors">
                                    <td class="p-4 font-bold text-gray-700">{{ $item->step_number }}</td>
                                    <td class="p-4">
                                        <div class="flex items-center gap-3">
                                            @if ($item->image)
                                    ...
                                    <td class="p-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button type="button"
                                                @click="openDeleteModal('{{ route('admin.edukasi.cek_tanah.destroy', $item->id) }}', '{{ $item->title }}')"
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="p-8 text-center text-gray-500">
                                        ...
                                        <p class="font-medium">Belum ada data langkah</p>
                                        <p class="text-sm mt-1">Klik tombol "Tambah Langkah" untuk menambah data baru.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
