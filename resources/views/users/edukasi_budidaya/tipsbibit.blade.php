        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            <div class="text-center max-w-3xl mx-auto space-y-6">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 tracking-tight leading-tight">
                    Tips Pemilihan <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-yellow-500">Bibit</span>
                </h1>
                <p class="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    Pilih komoditas tanaman Anda dan pelajari cara memilih bibit unggul untuk hasil panen maksimal.
                </p>
